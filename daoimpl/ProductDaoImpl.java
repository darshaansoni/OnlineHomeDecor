...
public class ProductDaoImpl implements ProductDao {
    ...
    public void addProduct(Product product) {
        try {
            String INSERT_PRODUCT = "insert into products (productName, productPrice, productDescription, productQuantity, productCategoryId, productSubCategoryId, productImage, userId) values (?, ?, ?, ?, ?, ?, ?, ?)";
